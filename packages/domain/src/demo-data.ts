...
export const demoProducts: Product[] = [
  ...
  },
  {
    ...
    category: "main",
    description: "Pizza mit Tomatensauce, Käse und Basilikum.",
    priceCents: 700,
    taxRate: 7,
  ...
  },
  {
    ...
    category: "main",
    description: "Pizza mit Tomatensauce, Käse und Kochschinken.",
    priceCents: 800,
    taxRate: 7,
    allergens: ["Gluten", "Milch"],
    showInKitchen: true,
  ...
  },
  {
    ...
    name: "Pizza Salami",
    category: "main",
    description: "Pizza mit Tomatensauce, Käse und Salami.",
    priceCents: 800,
    taxRate: 7,
    allergens: ["Gluten", "Milch"],
    showInKitchen: true,
  ...
  },
  {
    ...
    name: "Pizza Speziale",
    category: "main",
    description: "Pizza mit Tomatensauce, Käse, Salami, Kochschinken und Champignons.",
    priceCents: 800,
    taxRate: 7,
    allergens: ["Gluten", "Milch"],
    showInKitchen: true,
  ...
  },
  {
    ...
    category: "main",
    description: "Pizza mit Tomatensauce, Käse und Thunfisch.",
    priceCents: 800,
    taxRate: 7,
  ...
  },
  {
    ...
    name: "Pizza Veggi",
    category: "main",
    description: "Pizza mit Tomatensauce, Käse, Paprika, Champignons und Zwiebeln.",
    priceCents: 800,
    taxRate: 7,
    allergens: ["Gluten", "Milch"],
    showInKitchen: true,
