...
exports.demoAppState = exports.demoSessions = exports.demoProducts = exports.demoTables = exports.demoUsers = void 0;
const config_1 = require("../../config/src/index.ts");
const now = "2026-03-27T18:30:00.000Z";
const drinkSizeModifier = {
    id: "size-drink",
    name: "Größe",
    required: false,
    min: 0,
...
const createSeats = (tableId, count) => Array.from({ length: count }, (_, index) => ({
    id: `${tableId}-seat-${index + 1}`,
    label: `P${index + 1}`
}));
exports.demoTables = [
    { id: "table-1", name: "Tisch 1", seatCount: 3, active: true, plannedOnly: false, x: 63, y: 60, width: 15, height: 20, seats: createSeats("table-1", 3) },
    { id: "table-2", name: "Tisch 2", seatCount: 3, active: true, plannedOnly: false, x: 78, y: 60, width: 15, height: 20, seats: createSeats("table-2", 3) },
    ...
    { id: "table-5", name: "Tisch 5", seatCount: 3, active: true, plannedOnly: false, x: 33, y: 27, width: 14, height: 13, seats: createSeats("table-5", 3) },
    { id: "table-6", name: "Tisch 6", seatCount: 5, active: true, plannedOnly: false, x: 18, y: 27, width: 14, height: 13, seats: createSeats("table-6", 5) },
    {
        ...
        width: 16,
        height: 13,
        note: "Geplant, aktuell nicht gestellt",
...
const createTicket = (course, status, overrides = {}) => ({
    course,
    status,
    countdownMinutes: config_1.kitchenRules.releaseCountdownMinutes,
    manualRelease: false,
    ...overrides
});
...
exports.demoAppState = {
    users: exports.demoUsers,
    tables: exports.demoTables,
    products: exports.demoProducts,
    sessions: exports.demoSessions,
    notifications: [
        {
            id: "note-1",
